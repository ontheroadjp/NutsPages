...
<i class="fa fa-picture-o"></i> <?php echo e(_('Image Gallery')); ?>
...
<div id="dropzonejs-example" class="dropzone-box dz-clickable">
	<div class="dz-default dz-message">
		...
		<?php echo e(_('Drop files in here')); ?><br><span class="dz-text-small"><?php echo e(_('or click to pick manually')); ?></span>
	</div>
