            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header"><?php echo e(_('You have 4 messages')); ?></li>
                        <li>
                        ...
                        <li class="footer"><a href="#"><?php echo e(_('See All Messages')); ?></a></li>
                    </ul>
                </li><!-- /.messages-menu -->
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header"><?php echo e(_('You have 10 notifications')); ?></li>
                        <li>
                            <!-- Inner Menu: contains the notifications -->
                            <ul class="menu">
                                <li><!-- start notification -->
                                    <a href="#">
                                        <i class="fa fa-users text-aqua"></i> <?php echo e(_('5 new members joined today')); ?>

                                    </a>
                                </li><!-- end notification -->
                            </ul>
                        </li>
                        <li class="footer"><a href="#"><?php echo e(_('View all')); ?></a></li>
                    </ul>
                </li>
                <!-- Tasks Menu -->
                <li class="dropdown tasks-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header"><?php echo e(_('You have 9 tasks')); ?></li>
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- Task item -->
                                    <a href="#">
                                        ...
                                        <h3>
                                            <?php echo e(_('Design some buttons')); ?>
                        ...
                        <li class="footer">
                            <a href="#"><?php echo e(_('View all tasks')); ?></a>
                        </li>
                    </ul>
                </li>
                <!-- User Account Menu -->
