...
<div class="main-section">
    ...
    <div class="social-auth-links text-center">
        <p class="mg-30">- OR -</p>
        <a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> <?php echo e(_('Sign in using Facebook')); ?></a>
        <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i><?php echo e(_('Sign in using Google')); ?></a>
