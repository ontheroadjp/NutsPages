...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="{{ url('home') }}"><i class='fa fa-home'></i> <span>{{ _('Home') }}</span></a></li>
            ...
            <li class="treeview">
                <a href="#"><i class='fa fa-question'></i> <span>{{ _('Help') }}</span> <i class="fa fa-angle-left pull-right"></i></a>
