...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="/imagegallery"><i class='fa fa-picture-o'></i> <span>{{ _('Image Gallery') }}</span></a></li>
            <li><a href="/whois/search"><i class='fa fa-search'></i> <span>{{ _('Domain Search') }}</span></a></li>
            <li class="treeview">
